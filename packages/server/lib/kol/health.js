/**
 * KOL Radar — project HEALTH (the green/red endorsement signal) + legitimacy.
 *
...
function classifyHealth({ market_cap, change24h, change7d, athChange } = {}) {
...
function computeLegitimacy(endorsements) {
  let alive = 0
  let cooling = 0
  let dead = 0
  let unknown = 0
 ...
 */
async function getProjectHealth(cgIds) {
...
module.exports = { getProjectHealth, classifyHealth, computeLegitimacy }
