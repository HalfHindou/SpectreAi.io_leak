...
export const TOKEN_ROW_COLORS = {
  ...
  SOL: { bg: '153, 69, 255', gradient: 'linear-gradient(135deg, #b273ff 0%, #9945ff 50%, #6b30b2 100%)' },
  ...
  PEPE: { bg: '61, 158, 65', gradient: 'linear-gradient(135deg, #6db478 0%, #3d9e41 50%, #2b6f2d 100%)' },
  WIF: { bg: '153, 69, 255', gradient: 'linear-gradient(135deg, #b273ff 0%, #9945ff 50%, #6b30b2 100%)' },
  DOGE: { bg: '195, 166, 52', gradient: 'linear-gradient(135deg, #d2bd6b 0%, #c3a634 50%, #887424 100%)' },
  ...
  SHIB: { bg: '247, 147, 26', gradient: 'linear-gradient(135deg, #fab157 0%, #f7931a 50%, #ad6612 100%)' },
  ...
  NEAR: { bg: '0, 193, 222', gradient: 'linear-gradient(135deg, #4dd5e6 0%, #00c1de 50%, #00879a 100%)' },
  ...
  SUI: { bg: '77, 162, 255', gradient: 'linear-gradient(135deg, #80bdff 0%, #4da2ff 50%, #357186 100%)' },
  APT: { bg: '46, 216, 163', gradient: 'linear-gradient(135deg, #6be1bd 0%, #2ed8a3 50%, #209772 100%)' },
  INJ: { bg: '0, 242, 254', gradient: 'linear-gradient(135deg, #4df5fe 0%, #00f2fe 50%, #00a9b1 100%)' },
  RNDR: { bg: '0, 211, 149', gradient: 'linear-gradient(135deg, #4ddead 0%, #00d395 50%, #009468 100%)' },
  TAO: { bg: '28, 28, 30', gradient: 'linear-gradient(135deg, #555557 0%, #1c1c1e 50%, #141415 100%)' },
  FET: { bg: '29, 30, 78', gradient: 'linear-gradient(135deg, #555578 0%, #1d1e4e 50%, #141537 100%)' },
  ...
  SPECTRE: { bg: '212, 212, 216', gradient: 'linear-gradient(135deg, #d4d4d8 0%, #e5e5e7 40%, #f5f5f7 70%, #d4d4d8 100%)' },

  // ═══════════════ ADDITIONAL CRYPTO (synced with trading KNOWN_TOKEN_COLORS) ═══════════════
  HYPE: { bg: '80, 227, 194', gradient: 'linear-gradient(135deg, #97fce4 0%, #50e3c2 50%, #2fae91 100%)' },
  HYPERLIQUID: { bg: '80, 227, 194', gradient: 'linear-gradient(135deg, #97fce4 0%, #50e3c2 50%, #2fae91 100%)' },
  AAVE: { bg: '182, 80, 158', gradient: 'linear-gradient(135deg, #c97cb6 0%, #b6509e 50%, #7f386f 100%)' },
  WETH: { bg: '98, 126, 234', gradient: 'linear-gradient(135deg, #818cf8 0%, #627eea 50%, #4458a4 100%)' },
  WBTC: { bg: '247, 147, 26', gradient: 'linear-gradient(135deg, #fab157 0%, #f7931a 50%, #ad6612 100%)' },
  '$WIF': { bg: '153, 69, 255', gradient: 'linear-gradient(135deg, #b273ff 0%, #9945ff 50%, #6b30b2 100%)' },
  DOGWIFHAT: { bg: '153, 69, 255', gradient: 'linear-gradient(135deg, #b273ff 0%, #9945ff 50%, #6b30b2 100%)' },
  JUP: { bg: '0, 211, 149', gradient: 'linear-gradient(135deg, #4ddead 0%, #00d395 50%, #009468 100%)' },
  JUPITER: { bg: '0, 211, 149', gradient: 'linear-gradient(135deg, #4ddead 0%, #00d395 50%, #009468 100%)' },
  BONK: { bg: '255, 149, 0', gradient: 'linear-gradient(135deg, #ffaf40 0%, #ff9500 50%, #b26800 100%)' },
  MOODENG: { bg: '212, 165, 201', gradient: 'linear-gradient(135deg, #ddb8d3 0%, #d4a5c9 50%, #94748c 100%)' },
  'MOO DENG': { bg: '212, 165, 201', gradient: 'linear-gradient(135deg, #ddb8d3 0%, #d4a5c9 50%, #94748c 100%)' },
  PYTH: { bg: '107, 78, 230', gradient: 'linear-gradient(135deg, #9682ed 0%, #6b4ee6 50%, #4b36a1 100%)' },
  JTO: { bg: '20, 241, 149', gradient: 'linear-gradient(135deg, #50f4ad 0%, #14f195 50%, #0ea868 100%)' },
  JITO: { bg: '20, 241, 149', gradient: 'linear-gradient(135deg, #50f4ad 0%, #14f195 50%, #0ea868 100%)' },
  RENDER: { bg: '0, 211, 149', gradient: 'linear-gradient(135deg, #4ddead 0%, #00d395 50%, #009468 100%)' },
  BITTENSOR: { bg: '28, 28, 30', gradient: 'linear-gradient(135deg, #555557 0%, #1c1c1e 50%, #141415 100%)' },
  'FETCH.AI': { bg: '29, 30, 78', gradient: 'linear-gradient(135deg, #555578 0%, #1d1e4e 50%, #141537 100%)' },
  TIA: { bg: '123, 43, 249', gradient: 'linear-gradient(135deg, #9c60fb 0%, #7b2bf9 50%, #561eae 100%)' },
  SEI: { bg: '155, 28, 28', gradient: 'linear-gradient(135deg, #b45151 0%, #9b1c1c 50%, #6c1313 100%)' },
  ONDO: { bg: '26, 86, 219', gradient: 'linear-gradient(135deg, #5183e3 0%, #1a56db 50%, #123c99 100%)' },
  POPCAT: { bg: '255, 217, 61', gradient: 'linear-gradient(135deg, #ffe26d 0%, #ffd93d 50%, #b29728 100%)' },
  WEN: { bg: '153, 69, 255', gradient: 'linear-gradient(135deg, #b273ff 0%, #9945ff 50%, #6b30b2 100%)' },
  BOME: { bg: '255, 107, 53', gradient: 'linear-gradient(135deg, #ff9068 0%, #ff6b35 50%, #b24b25 100%)' },
  RAY: { bg: '79, 195, 247', gradient: 'linear-gradient(135deg, #7bd2f9 0%, #4fc3f7 50%, #3789ad 100%)' },
  RAYDIUM: { bg: '79, 195, 247', gradient: 'linear-gradient(135deg, #7bd2f9 0%, #4fc3f7 50%, #3789ad 100%)' },
  PIPPIN: { bg: '125, 211, 252', gradient: 'linear-gradient(135deg, #9cdefd 0%, #7dd3fc 50%, #5793b0 100%)' },

  // ═══════════════ COMMODITY FUTURES ═══════════════
  'GC=F': { bg: '255, 198, 0', gradient: 'linear-gradient(135deg, #ffc600 0%, #ffd633 40%, #ffe066 70%, #ffc600 100%)' },    // Gold — bright gold
  'SI=F': { bg: '192, 192, 192', gradient: 'linear-gradient(135deg, #c0c0c0 0%, #d4d4d4 40%, #e8e8e8 70%, #c0c0c0 100%)' }, // Silver — metallic silver
  'CL=F': { bg: '30, 30, 30', gradient: 'linear-gradient(135deg, #1e1e1e 0%, #3a3a3a 40%, #555555 70%, #1e1e1e 100%)' },     // Crude Oil — dark petroleum
  'NG=F': { bg: '0, 150, 255', gradient: 'linear-gradient(135deg, #0096ff 0%, #33aaff 40%, #66bfff 70%, #0096ff 100%)' },     // Natural Gas — blue flame
  'HG=F': { bg: '184, 115, 51', gradient: 'linear-gradient(135deg, #b87333 0%, #cc8844 40%, #dda066 70%, #b87333 100%)' },    // Copper — copper brown
  'PL=F': { bg: '229, 228, 226', gradient: 'linear-gradient(135deg, #e5e4e2 0%, #d1d0ce 40%, #bdbcba 70%, #e5e4e2 100%)' },  // Platinum — light platinum
  'PA=F': { bg: '186, 196, 200', gradient: 'linear-gradient(135deg, #bac4c8 0%, #a6b2b8 40%, #929ea4 70%, #bac4c8 100%)' },  // Palladium — steel blue-gray

  // ═══════════════ COMMODITY ETFs ═══════════════
  // GLD / SLV / USO / UNG used to be defined here too, with brighter,
  // more literal colors (gold #ffc600, oil black #1e1e1e). They were
  // silently overridden by the ETF block further down, so those values
  // never rendered. Removed the dead half - behaviour is unchanged.
  // If the commodity palette was the intended one, change it THERE.
  IAU:  { bg: '255, 198, 0', gradient: 'linear-gradient(135deg, #ffc600 0%, #ffd633 50%, #ffe066 100%)' },
  CPER: { bg: '184, 115, 51', gradient: 'linear-gradient(135deg, #b87333 0%, #cc8844 50%, #dda066 100%)' },
  NEM:  { bg: '255, 198, 0', gradient: 'linear-gradient(135deg, #ffc600 0%, #d4a800 50%, #aa8500 100%)' },
  GOLD: { bg: '255, 198, 0', gradient: 'linear-gradient(135deg, #ffc600 0%, #d4a800 50%, #aa8500 100%)' },
  ...
  ZIG: { bg: '0, 212, 170', gradient: 'linear-gradient(135deg, #00d4aa 0%, #00e6b8 40%, #14f5c6 70%, #00d4aa 100%)' },
}
