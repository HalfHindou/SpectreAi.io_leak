/**
 * KOL Radar — pluggable follow-graph provider (ESM serverless mirror of the dev
 * CJS provider at packages/server/lib/kol/provider.js).
 *
...
async function mockGetFollowing(handle, { limit = 60 } = {}) {
  ...
  const { projects, hot, prePush } = plan
