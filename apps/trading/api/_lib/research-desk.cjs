 ...
 *     .js  : require('./trending-score.cjs')      require('./dexscreener-enrich.cjs')
...
const { scoreTraction, isTrendingEligible, normalizeCodexChange } = require('./trending-score.cjs')
const { enrichFromDexScreener, norm } = require('./dexscreener-enrich.cjs')
