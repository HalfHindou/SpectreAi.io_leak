 ...
 * Ported from research app with inline SVG copy icon (no lucide-react).
 */
...
export default function UdReferralSection({ referralCode, referralStats, loading, onApplyCode, triggerCopyToast }) {
  ...
  const handleApply = async () => {
    ...
    if (result.success) {
      setInputCode('')
      triggerCopyToast('Referral code applied!')
    }
  }
    ...
    <section className="ud-card ud-referral">
      ...
      <div className="ud-referral-your-code">
        ...
        <div className="ud-referral-code-row">
          ...
          <button type="button" className="ud-referral-copy" onClick={handleCopyCode} title="Copy referral code">
