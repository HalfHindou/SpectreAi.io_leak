      ...
      function h(e) {
        ...
        return r.createElement(
          h,
          {
            ...v,
            ref: m,
            className: o()(c.tab, g && c.isTablet, f && c.isMobile, d && c.active, p),
            onClick: u,
          },
      ...
      function ie(e) {
        ...
        return (
          (0, r.useEffect)(() => {
            var e;
            a || u(""),
              _.CheckMobile.any() || null === (e = P.current) || void 0 === e || e.focus();
          }, [a]),
                      ...
                      : v.length
                        ? r.createElement(
                            ...
                            r.createElement(
                              W,
                              null,
                              r.createElement(F, { title: o.t(null, void 0, n(15491)) }),
                            ),
                            v.map((e) =>
                              r.createElement(L, {
                                key: e.id,
            ...
            return (
              n.forEach((e) => {
                ...
                if (
                  ...
                  return (
                    (h = 4), void (u = null === (n = t.match(p)) || void 0 === n ? void 0 : n.index)
                  );
                if ((0, r.isString)(t) && p.test(t))
                  return (
                    (h = 3), void (u = null === (a = t.match(p)) || void 0 === a ? void 0 : a.index)
                  );
                if ((0, r.isString)(o) && p.test(o))
                  return (
                    (h = 2), void (u = null === (s = o.match(p)) || void 0 === s ? void 0 : s.index)
                  );
                if ((0, r.isString)(o) && m.test(o))
                  return (
                    (h = 2), void (u = null === (l = o.match(m)) || void 0 === l ? void 0 : l.index)
                  );
                if (Array.isArray(d))
                  for (const e of d)
                    if (p.test(e))
                      return (
                        (h = 1),
                        void (u = null === (c = e.match(p)) || void 0 === c ? void 0 : c.index)
                      );
              }),
